// EffectEdit2.h : main header file for the EFFECTEDIT application
//
...
public:
    ...
    const CString& MediaSearchPath() { return m_MediaSearchPath; }

private:
    BOOL m_bUseExternalEditor;

    BOOL m_WaitingForSearchPath;
    CString m_MediaSearchPath;
};
...
{
    CString m_MediaPath;
    bool m_MediaPathIsValid;

public:
    CEffectEditDocManager()
    {
        m_MediaPathIsValid = false;
    }

    bool IsMediaPathValid() const
    {
        return m_MediaPathIsValid;
    }

    void SetMediaPath(const CString& MediaPath);
...
public:
    ...
    bool AppActivated() { return m_bAppActivated; }
    void SetAppActivated(bool b) { m_bAppActivated = b; }
