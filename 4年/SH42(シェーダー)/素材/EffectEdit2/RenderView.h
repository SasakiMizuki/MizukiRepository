...
protected:
    ...
    ID3DXFont* m_pFont;
    CD3DArcBall m_ArcBallMesh;      // mouse rotation utility
    CD3DArcBall m_ArcBallView;      // mouse rotation utility
    ...
    D3DXHANDLE m_MaterialEmissiveEffectHandle;
	D3DXHANDLE m_MaterialTextureEffectHandle;
	D3DXHANDLE m_MaterialTextureValidEffectHandle;
    ...
    LPDIRECT3DCUBETEXTURE9 m_pEnvironmentTexture;
