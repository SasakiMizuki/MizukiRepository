...
bool CGraphics::Initialize(HWND hWnd, int nWidth, int nHeight, bool bWindow)
{
	...
	//-------- ここから３Ｄ関連
	// ビューマトリックス設定
//	m_vCamera = D3DXVECTOR3(m_nWidth / 2.0f, 0.0f, //-1000.0f),
//							-(m_nHeight / 2) / tanf(D3DXToRadian(FOVY) / 2));
	m_vCamera = D3DXVECTOR3(0.0f, 1.0f, -2.0f);
	m_vLookAt = D3DXVECTOR3(0.0f, 0.7f, 0.0f);
	...
	vecDir = D3DXVECTOR3(2.0f, -1.0f, 0.5f);					// 光の向きを決める
