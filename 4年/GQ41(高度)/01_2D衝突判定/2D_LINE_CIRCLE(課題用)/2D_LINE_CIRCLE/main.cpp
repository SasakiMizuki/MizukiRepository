...
bool HitCheck()
{
	...
	*************************************************************************/
	if (((pow(g_Circle.pos_x - g_Line.pos_x0) + pow(g_Circle.pos_y - g_Line.pos_y0)) < pow(g_Circle.radius)) ||
		((pow(g_Circle.pos_x - g_Line.pos_x1) + pow(g_Circle.pos_y - g_Line.pos_y1)) < pow(g_Circle.radius)))
		return true;

	float t = (float)((g_Circle.pos_x - g_Line.pos_x0) * (g_Line.pos_x1 - g_Line.pos_x0) + 
			   (g_Circle.pos_y - g_Line.pos_y0) * (g_Line.pos_y1 - g_Line.pos_y0))
			 / (pow(g_Line.pos_x1 - g_Line.pos_x0) + pow(g_Line.pos_y1 - g_Line.pos_y0));
	...
	if (pow(g_Circle.pos_x - g_Vx) + pow(g_Circle.pos_y - g_Vy) < pow(g_Circle.radius)) {
		return true;
	}
